...
function addImage(src) {
  ...
  var image_id = src.split('/')[4].split(".")[0]*1;
  var newLink = document.createElement("a")
  newDiv.appendChild(newImg);
  document.getElementById("thumbnails").appendChild(newDiv);
  newLink.setAttribute('href', "#");
  newLink.onclick = function() {new Ajax.Request('/gallery/' + image_id , {asynchronous:true, evalScripts:true, method:'delete'});};
  //newLink.setEvent('onclick', "");
  newLink.innerHTML = "x";
	if (newImg.filters) {
		try {
  ...
  new Insertion.After(newImg, newLink);
	newImg.src = src;

}

function ajax_call(image_id){
